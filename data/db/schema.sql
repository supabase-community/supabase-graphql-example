...
--
-- Name: DownVote; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE "DownVote"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public."DownVote" IS '@graphql({"totalCount": {"enabled": true}})';
...
ALTER TABLE public."DownVote" ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: UpVote; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE "UpVote"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public."UpVote" IS '@graphql({"totalCount": {"enabled": true}})';


--
-- Name: UpVote_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public."UpVote" ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."UpVote_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: DownVote DownVote_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: UpVote UpVote_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DownVote DownVote_postId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DownVote DownVote_profileId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: UpVote UpVote_postId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."UpVote"
    ADD CONSTRAINT "UpVote_postId_fkey" FOREIGN KEY ("postId") REFERENCES public."Post"(id);


--
-- Name: UpVote UpVote_profileId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."UpVote"
    ADD CONSTRAINT "UpVote_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES public."Profile"(id);
